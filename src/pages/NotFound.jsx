...
export default function NotFound() {
    ...
    const [theme, setTheme] = useState(() => {
        try {
            return localStorage.getItem("nf_theme") || "draper";
        } catch {
            return "draper";
        }
    });
    ...
    useEffect(() => {
        function onKey(e) {
            ...
            if (k === "h") navigate("/");
            if (k === "r") restoreQuote();
            if (k === "d") setTheme((t) => (t === "light" ? "dark" : t === "dark" ? "draper" : "light"));
        }
    ...
    return (
        <div className="notfound-root" role="document" aria-labelledby="nf-title">
            ...
            >
                <div className="brand-row">
                    ...
                    <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                        <button
                            ...
                            onClick={() => setTheme((t) => (t === "light" ? "dark" : t === "dark" ? "draper" : "light"))}
                ...
                <h2 className="notfound-title">You’ve taken the scenic route.</h2>
